...
globalkeys = gears.table.join(
  ...
  awful.key({modkey}, "F1", function()
    awful.spawn.easy_async_with_shell("amixer -q -D pulse sset Master toggle",
      function() awesome.emit_signal("toggle down the volume") end)
  ...
  awful.key({modkey, 	   }, "XF86AudioLowerVolume", function()
    awful.spawn.easy_async_with_shell("bash ~/.config/awesome/shell/xback.sh 0",
      function() awesome.emit_signal("volume_refresh") end)
  end,{description = "Set the brightness to improve", group = "brightness"}),
  awful.key({modkey, 	   }, "XF86AudioRaiseVolume", function()
    awful.spawn.easy_async_with_shell("bash ~/.config/awesome/shell/xback.sh 1",
      function() awesome.emit_signal("volume_refresh") end)
